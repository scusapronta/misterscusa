...
const excuseFragments = {
  lavoro: { start:[ "Giuro che stavo arrivando, ma","Allora, il punto è che","Ti dico la verità:","Piccolo aggiornamento sulla mia puntualità:","Lo so che suona male, ma","Stavo partendo in orario, solo che","Mi ero organizzato benissimo, finché","La mia intenzione era essere in anticipo, però","Non è colpa mia (credo), perché","Vorrei dire che è colpa del traffico, ma","Sono uscito di casa con le migliori intenzioni, ma","Avevo impostato tutto perfettamente, tuttavia","Nonostante tre sveglie e un caffè,","Mi ero persino vestito in anticipo, solo che","Ho provato a essere una persona puntuale, ma" ],
    reason:[ "il treno ha deciso di fermarsi a caso in mezzo al nulla","il bus sembrava in sciopero personale","Google Maps mi ha mandato letteralmente nel lato sbagliato della città","il vicino ha deciso di usare il trapano alle 7 di mattina","il caffè ha fatto più danni che benefici","la sveglia ha suonato, ma solo dentro il mio cuore","il mio pc ha deciso di aggiornarsi proprio quando dovevo uscire","il cane ha rubato una scarpa e ho dovuto negoziare","il gatto ha pensato fosse il momento giusto per sdraiarsi sulla tastiera","il condominio ha organizzato un concerto di rumori improvvisati","il mio router ha pensato fosse ora di un reset spirituale","la caldaia ha scelto oggi per avere una crisi esistenziale","il citofono ha suonato tre volte di fila per pacchi non miei","il mio cervello ha confuso l’ora di ingresso con l’ora di uscita","ho sbagliato clamorosamente fuso orario mentale","un misterioso ingorgo ha bloccato la strada più semplice","il parcheggio ha deciso di diventare un miraggio","un temporale random ha rallentato tutto il mondo tranne l’orologio","il mio outfit ha fatto crashare l’autostima e ho dovuto ricominciare da capo","ho perso cinque minuti qui, dieci lì, ed è diventata un’ora" ],
    detail:[ "e ho dovuto capire se fossi ancora nel 2025 o in un universo parallelo.","e da lì è iniziata una catena di eventi degna di una serie TV.","e da quel momento la logica ha smesso di avere senso.","e sistemare la situazione ha richiesto più tempo del previsto.","e se ti mando le prove penserai che sia un meme.","e mi ci è voluto un po’ per risolvere il casino.","e ho capito che l’universo oggi non gioca dalla mia parte.","e da lì il tempo ha iniziato a correre più veloce di me.","e ogni volta che provavo a recuperare succedeva un imprevisto nuovo.","e ovviamente tutto questo è capitato proprio oggi.","e a quel punto recuperare la puntualità era matematicamente impossibile.","e credo di aver sbloccato un nuovo livello di sfiga logistica.","e ogni tentativo di accelerare ha solo peggiorato la situazione.","e mi sono ritrovato a correre dietro all’orologio senza successo.","e più cercavo di sbrigarmi, più il mondo rallentava.","e giuro che neanche in un film sarebbe credibile.","e penso di aver perso ufficialmente il controllo della tabella di marcia.","e non saprei neanche da dove iniziare a raccontare tutto.","e la cronologia degli eventi sembra scritta da un comico.","e sono arrivato al punto di ridere per non piangere." ],
    end:[ "Arrivo il prima possibile, promesso.","Recupero tutto, anche se oggi sembra una missione impossibile.","Giuro che non è pigrizia, è solo sfiga organizzata.","Se servono dettagli, ho un intero romanzo da raccontare.","La prossima volta metto la sveglia anche al frigorifero.","Da domani divento una persona puntuale, o almeno ci provo.","Prometto che rientro nelle grazie del karma lavorando extra.","Se può aiutare, oggi porto anche la mia coscienza con me.","Per farmi perdonare oggi faccio anche le call difficili.","Oggi la mia produttività parte in ritardo, ma poi recupera.","Segno questa giornata come esempio di cosa non fare più.","Userò questo ritardo come motivazione per migliorare (domani).","La mia puntualità oggi è in beta, ma si aggiornerà.","Consideriamolo un test di pazienza, superato da te.","Porterò caffè, report e pentimento in parti uguali." ]
  },
  amici:{ start:[ "Lo so, sembro la persona peggiore del gruppo, ma","Raga, non odiatemi, però","Vi voglio bene, quindi sarò sincero:","Vi chiedo perdono in anticipo perché","Giuro che non è una scusa cheap, ma","So che dovevo esserci, però","Ero prontissimo ad uscire, poi","La mia parte sociale ce l’ha messa tutta, ma","Non voglio diventare il friend tossico, però","Appena ho messo un piede fuori casa","Stavo per scrivere 'arrivo', invece","La versione socievole di me oggi","Ho aperto l’armadio per vestirmi e","Vi stavo per dire 'ci sono', quando","Mi ero già immaginato la serata, ma" ],
    reason:[ "il divano mi ha guardato negli occhi e mi ha chiesto di restare","il mio livello di energia sociale è finito al -3","ho realizzato che oggi ho fatto finta di essere un adulto per troppe ore","il meteo interno ha segnato pigrizia con possibilità di sonno","ho iniziato a prepararmi e ho perso la motivazione cercando le calze","il mio outfit ha smesso di avere senso appena l’ho indossato","la mia mente ha premuto alt+f4 sulla modalità uscire","è partita una combo letale tra fame, stanchezza e noia","il mio corpo ha deciso che oggi è modalità risparmio energetico","ho avuto un improvviso bisogno di non vedere nessun essere umano","la mia voglia di uscire è scesa sotto lo zero assoluto","la mia social battery si è spenta senza preavviso","mi sono seduto 'un minuto' e il tempo è evaporato","mi è partita la modalità non-disturbare sulla vita reale","mi sono ricordato di non aver avuto un giorno off mentale da settimane" ],
    detail:[ "e onestamente non voglio rovinare la serata col mio mood da panda stanco.","e finirei a fare la pianta grassa in un angolo del locale.","e non credo di avere la faccia adatta per fingere entusiasmo credibile.","e la mia batteria sociale ha bisogno di un reset totale.","e l’unica cosa che il mio cervello supporta è tuta e serie TV.","e rischierei di addormentarmi sul tavolo a metà frase.","e non voglio essere quella persona che sta lì e guarda il vuoto.","e l’unico contatto umano che reggo oggi è quello col cuscino.","e penso che il mondo sia più sicuro se resto sul divano.","e se esco in queste condizioni divento un meme vivente.","e vi meritate una versione di me più viva, non in modalità zombie.","e sarebbe come portare un NPC al vostro tavolo.","e non voglio trasformare la vostra serata in un documentario sulla stanchezza.","e preferisco mancare oggi che smorzare l’energia del gruppo.","e rischierei di rispondere a monosillabi tutta la sera." ],
    end:[ "Recuperiamo nei prossimi giorni, promesso, birra inclusa.","La prossima volta offro io, così bilanciamo il karma.","Non cancellatemi dal gruppo, vi prego.","Metto già in calendario una serata extra per farmi perdonare.","Resto umano, solo con Wi-Fi e pigiama.","Vi mando vocali imbarazzanti come pegno.","Vi devo almeno due serate di fila per rimediare.","Vi autorizzo a rinfacciarmelo alla prossima occasione.","Faccio ammenda con cibo, tanto cibo.","Vi mando meme tutta la sera in segno di presenza spirituale.","Metto un promemoria solo per voi, giuro.","La prossima volta se non vengo potete venire a prendermi da casa.","Vi lascio carta bianca per prendermi in giro.","Mettiamo data fissa, senza possibilità di forfait.","Mi impegno ufficialmente a non sparire per le prossime due uscite." ]
  },
  amore:{ start:[ "Ok, prima che ti arrabbi, lascia che ti spieghi:","Prometto che non è la solita scusa, ma","So che sembra sospetto, però","Non voglio litigare, quindi te lo dico subito:","Ti giuro che non è perché non voglio vederti, ma","Lo so che ti meriti qualcuno più organizzato di me, però","Prima che pensi male:","Non prendertela con me, ma con il destino perché","Ho un annuncio poco romantico:","Se ti dico la verità, non ti arrabbi troppo, vero?","Ho passato tutta la giornata pensando di vederti, ma","La mia testa e il mio corpo oggi non collaborano, perché","Ti scrivo con affetto e un po’ di senso di colpa:","Vorrei dirti che è tutto sotto controllo, ma","Ti devo una spiegazione da adulto, ma con anima stanca:" ],
    reason:[ "la mia giornata è esplosa in mille micro problemi tutti insieme","il tempo oggi ha deciso di essere contro di noi","sono fisicamente distrutto e ho paura di essere solo metà persona con te","il caos che ho in testa non merita di investirti","se esco adesso rischio di portarti solo la versione laggata di me stesso","sono talmente stanco che potrei addormentarmi mentre mi guardi negli occhi","ho una serie di cose urgenti da chiudere che non spostano, ma stressano","il mio cervello ha deciso che oggi è manutenzione straordinaria","non voglio vederti di corsa e con l’ansia addosso","se ci vediamo ora, parlo solo in buffering","ho fatto troppo il forte e ora il corpo mi presenta il conto","sono rimasto intrappolato tra doveri, notifiche e imprevisti","oggi mi sento più vicino a una batteria scarica che a un essere umano","ho sottovalutato quanto mi avrebbe steso questa giornata","non voglio trascinare fino a te tutta questa stanchezza" ],
    detail:[ "e tu meriti una versione di me che non sbadiglia ogni 30 secondi.","e preferisco rimandare piuttosto che stare insieme male.","e vorrei vederti quando posso davvero essere presente, non solo fisicamente.","e non voglio trasformare il tempo con te in una checklist.","e preferisco arrivare da te con la testa e il cuore, non solo con il corpo.","e voglio che quando ci vediamo sia un momento bello, non un’aggiunta caotica alla giornata.","e so che forse non sembra, ma lo faccio proprio perché ci tengo.","e non mi va di farti vivere la mia giornata in slow motion.","e non voglio appoggiarmi a te solo come antistress umano.","e vorrei che ogni volta che ci vediamo sia qualcosa da ricordare, non da sopportare.","e non mi piace l’idea di vederti e sentirmi ancora in modalità sopravvivenza.","e vorrei poter arrivare da te con un minimo di energia in più.","e se ti vedo, voglio poterti ascoltare davvero, non solo annuire.","e preferisco spostare di un giorno che rovinare una serata nostra.","e non voglio che ti sembri che ti stia dando solo gli avanzi del mio tempo." ],
    end:[ "Ti va se recuperiamo domani con più calma e più noi?","Prometto di compensare con una versione di me al 110%.","Se vuoi arrabbiarti lo capisco, ma ci tengo davvero a noi.","Non è una fuga, è solo un pit stop per arrivare meglio da te.","Ti mando un abbraccio virtuale, in attesa di quello vero.","Scrivimi pure tutto quello che pensi, ci sto.","Nel dubbio, mi sto già organizzando per il recupero ufficiale.","Non ti sto evitando, sto solo cercando di arrivare da te meglio di così.","Se reggi ancora un giorno, ti prometto che ne varrà la pena.","Ti devo una serata bella, senza fretta e senza scuse.","Mettiamoci d’accordo per quando posso essere più presente davvero.","Considera questa una pausa tecnica per tornare in forma.","La prossima volta vengo con energie, tempo e magari anche dolci.","Appena riesco a respirare meglio, la prima cosa che faccio è vederti.","Grazie se hai voglia di avere pazienza anche oggi." ]
  },
  famiglia:{ start:[ "Prometto che non lo faccio apposta, ma","Lo so che sembra che vi eviti, però","Non è che non vi voglio vedere, solo che","Prima che parta il dibattito familiare:","Giuro che non è ingratitudine, è solo organizzazione pessima perché","Non arrabbiatevi subito, ascoltate:","Vi voglio bene, ma oggi","Non prendetela sul personale, perché","Lo dico con affetto e un po’ di ansia:","Non sono sparito, è solo che","Vi assicuro che non è una fuga dalla famiglia, ma","Vi penso, anche se oggi","Non voglio sembrare quello che non ha mai tempo, ma","Vi chiedo solo un po’ di comprensione perché","Non so come dirvelo bene, ma" ],
    reason:[ "ho una giornata incastrata malissimo tra impegni e imprevisti","mi sono reso conto all’ultimo che ho sovrastimato le mie energie","il tempo mi è scappato di mano in modo imbarazzante","sono in ritardo con mille cose che non posso più rimandare","sto cercando di chiudere alcune cose importanti prima di vedervi","se esco ora lascio tutto a metà e peggioro solo il caos","la mia testa è un browser con 48 tab aperte e nessuna musica","la giornata è partita storta e non si è ancora raddrizzata","tra una cosa e l’altra è saltata completamente la mia pianificazione","non voglio arrivare da voi stanco e nervoso","ho promesso troppe cose a troppe persone oggi","il cervello è in modalità 'sopravvivere', non 'spostarsi'","sono in ritardo con cose pratiche che devo assolutamente sistemare","sono arrivato al punto di parlare da solo per organizzarmi","sto cercando di mettere ordine nel caos prima di farmi vedere" ],
    detail:[ "e non mi va di portarvi solo la versione stremata di me.","e preferisco venire quando posso essere presente davvero.","e voglio evitare di arrivare nervoso e scaricare tutto su di voi.","e vorrei che il tempo insieme fosse di qualità, non solo di presenza.","e non mi piace vedervi quando sono con la testa altrove.","e non voglio trasformare una visita in un altro impegno da spuntare.","e preferisco organizzarmi meglio per la prossima volta.","e voglio che quando vengo sia un momento bello, non di corsa.","e preferisco recuperare in modo decente, non al volo.","e so che magari non sembra, ma lo faccio anche per rispetto.","e non voglio che vi arrivi solo la versione nervosa del mio carattere.","e ci tengo a vedervi quando posso ascoltare e parlare con calma.","e non vorrei mettermi lì a lamentarmi tutta la visita.","e preferisco rinviare piuttosto che arrivare e guardare l’orologio ogni cinque minuti.","e voglio evitare di sembrare presente col corpo ma assente con la testa." ],
